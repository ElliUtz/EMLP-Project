 ...
 "cells": [
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       ...
       "top              NaN  Movie  The Silence                 United States   \n",
  ...
  },
  {
   ...
   "source": [
    ...
    "data_description_svd = svd.fit_transform(data_description)\n",
  ...
  },
  {
   ...
   "metadata": {},
   "source": [
    "Das würde ich jetzt eigentlich gerne für alle machen, aber halt in einer Matrix, nicht jede Matrix einzeln. Ich hoffe, man versteht, was ich meine."
   ]
  }
 ],
 "metadata": {
